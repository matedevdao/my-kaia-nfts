...
export default class Layout extends View {
    ...
    constructor() {
        ...
        this.container = el(".layout", el("header", el("h1", el("a", "My Kaia NFTs", { onclick: () => Router.go("/") })), el(".button-container", new LoggedInUserAvatarButton(KaiaWalletLoginManager))), this.contentContainer = el("main")).appendTo(AppRoot);
    }
}
